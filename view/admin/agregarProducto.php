  ...
  <div class="modal fade" id="agregarProducto" tabindex="-1" role="dialog" aria-labelledby="modalTitleId" aria-hidden="true">
        ...
        <div class="modal-body">
          <form action="../../controller/productoController.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-2">
              ...
              <input type="file" class="form-control" name="imagen" id="imagen" accept=".png, .jpg, jpeg, .svg, .webp" aria-describedby="helpId" required/>
            </div>
            <div class="mb-2">
            ...
            <div>
              ...
              <input type="submit" class="btn btn-primary" name="btnAgregar" value="Guardar">
            </div>
          </form>
        </div>
